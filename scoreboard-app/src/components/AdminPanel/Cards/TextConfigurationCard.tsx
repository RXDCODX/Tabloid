...
const TextConfigurationCard: React.FC<TextConfigurationCardProps> = ({
  ...
  const handleTextChange = (field: keyof TextConfiguration, value: string) => {
    onTextConfigChange({
      ...textConfig,
      [field]: value,
    });
          ...
          <div className="col-md-6 mb-3">
            <Form.Group>
              ...
              <Form.Control
                ...
                onChange={(e) => handleTextChange('player1NameText', e.target.value)}
              />
          ...
          <div className="col-md-6 mb-3">
            <Form.Group>
              ...
              <Form.Control
                ...
                onChange={(e) => handleTextChange('player2NameText', e.target.value)}
              />
              <Form.Text className="text-muted">
          ...
          <div className="col-md-6 mb-3">
            <Form.Group>
              ...
              <Form.Control
                ...
                onChange={(e) => handleTextChange('player1ScoreText', e.target.value)}
              />
              <Form.Text className="text-muted">
          ...
          <div className="col-md-6 mb-3">
            <Form.Group>
              ...
              <Form.Control
                ...
                onChange={(e) => handleTextChange('player2ScoreText', e.target.value)}
              />
              <Form.Text className="text-muted">
                Если пусто, будет использован счет игрока
              </Form.Text>
          ...
          <div className="col-md-6 mb-3">
            <Form.Group>
              ...
              <Form.Control
                ...
                onChange={(e) => handleTextChange('tournamentTitleText', e.target.value)}
              />
              <Form.Text className="text-muted">
          ...
          <div className="col-md-6 mb-3">
            <Form.Group>
              ...
              <Form.Control
                ...
                onChange={(e) => handleTextChange('fightModeText', e.target.value)}
              />
              <Form.Text className="text-muted">
